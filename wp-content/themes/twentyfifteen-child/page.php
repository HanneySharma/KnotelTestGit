    ...
    <div>
      <div class="container-fluid" data-radium="true">
        ...
        <div class="" data-radium="true" style="min-height: 600px; font-weight: 100;">
          <div class="container terms-main" data-radium="true" style="font-size: 14px; line-height: 22px;  ">
            
            <?php
                        while ( have_posts() ) : the_post();
                       
                        
                        echo '<p class="rmq-88d83e45 gtm-black" data-radium="true" style="color: rgb(187, 159, 125); margin-bottom: 5px; font-size: 48px; text-transform: uppercase; line-height: 55px;">'.get_the_title().'</p>';
                        the_content();
                        endwhile;
                        wp_reset_query();
                    ?>

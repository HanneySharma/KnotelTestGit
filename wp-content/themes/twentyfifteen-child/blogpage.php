...
<div class="row">
    ...
    <?php
        // Start the loop.
        $category = get_category(14);
        $cnt = $category->category_count;
        $i = 0;
        //$paged = ( get_query_var( 'paged' ) ) ? get_query_var( 'paged' ) : 1;
        $args = array('cat' => 14,'order' =>'ASC','posts_per_page' => 1000);
        query_posts($args);
        while ( have_posts() ) : the_post(); 
    ...
    <?php
        if($i % 3 == 0  && $i < $cnt){
    ?>
    </div><div class="row presscon" style="display:<?php echo ($i > 3)? 'none' : 'block'; ?>">
    <?php
        }
    ?>
    
<article class="col-lg-4 col-md-4 col-sm-6 col-xs-12 view-first" style="float: left;">
	<div class="view">
            <a href="<?php echo $link; ?>"><img src="<?php echo $img; ?>"></a>
        </div>
<div class="blog-details blog-listing-page">
    <div class="blog-title"><a href="<?php echo $link; ?>"><?php the_title(); ?></a></div>
    <div class="blog-short-descriptionhh">
        <?php echo $shortcontentxt; ?>
    </div>
     <?php 
              if(strlen($shortcontent) > 350 ){
                    ?>
...
echo '<div class="more-press-main">';
    echo '<a class="read-btn center-block kbtn" id = "loadmoreblogs" href="#" act="more" style="color: #fff;">LOAD MORE</a>';
echo '</div>';
}
?>  
...
<script>
    ...
    $(document).ready(function(){   
        $("a#loadmoreblogs").click(function(Evt) {
                Evt.preventDefault();
                ...
                if(hidden > 0){
                    ...
                    if(hidden == 0){                    
                        $(document).find("a#loadmoreblogs").hide();
                    }

                } else {
                   $("a#loadmoreblogs").hide();
                }
        });
    });

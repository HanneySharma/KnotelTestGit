...
<div id="render-target" style="width:100%; height:100%;">
  <div data-reactroot="" data-radium="true">
    <div>
      <div class="container-fluid" data-radium="true">
        <div class="row">
          <div class="col-xs-12"><a href="<?php echo get_home_url(); ?>">
            <div class="rmq-c4aee8dd" data-radium="true" style="display: inline-block; width: 120px; height: 120px; border-radius: 50%; position: relative; text-align: center; overflow: hidden; float: left; margin: 12px 52px 12px 0px; background-color: rgb(187, 159, 125);">
        ...
        <div class="" data-radium="true" style="min-height: 600px; font-weight: 100;">
          <div class="container terms-main" data-radium="true" style="font-size: 16px; line-height: 24px;  ">
            
            <?php
                        while ( have_posts() ) : the_post();
                       
                        
                        echo '<p class="rmq-88d83e45 gtm-black" data-radium="true" style="color: rgb(187, 159, 125); margin-bottom: 20px; font-size: 37px; text-transform: uppercase; line-height: 1.2em;">'.get_the_title().'</p>';
                        the_content();
                        endwhile;
                        wp_reset_query();
                    ?>
      ...
      <div style="position: fixed; left: 50%; display: flex; bottom: 0px; z-index: 2900; visibility: hidden; transform: translate(-50%, 48px); transition: transform 400ms cubic-bezier(0.23, 1, 0.32, 1) 0ms, visibility 400ms cubic-bezier(0.23, 1, 0.32, 1) 0ms;">
        <div width="3" style="font-family: Roboto, sans-serif; padding: 0px 24px; height: 48px; line-height: 48px; border-radius: 2px; max-width: 568px; min-width: 288px; width: auto; flex-grow: 0; background-color: rgba(0, 0, 0, 0.870588);">
  ...
  <style>
@media screen and (max-width:768px){ .rmq-88d83e45{text-align: center !important;}}

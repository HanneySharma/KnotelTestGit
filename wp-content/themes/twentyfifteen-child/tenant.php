...
<div id="render-target" style="width:100%; height:100%;">
  <div data-reactroot="" data-radium="true">
    <div>
      <div class="container-fluid ">
        <div class="row">
          <div class="col-xs-12"><a href="<?php echo get_home_url(); ?>">
            <div data-radium="true" style="display: inline-block; width: 120px; height: 120px; border-radius: 50%; position: relative; text-align: center; overflow: hidden; float: left; margin: 12px 52px 12px 0px; background-color: rgb(187, 159, 125);">
      ...
      <div class="container brokers tenant-reps-main" style="min-height: 600px; ">
        <div class="gtm-thin" style="font-size: 16px; line-height: 24px; ">
          <?php
    ...
    <style>
.brokers li{list-style-type: decimal;}.brokers table {
  border: 1px solid #000000;
  border-collapse: collapse;
  margin: 5px 0 15px;
  width: 100%;
}
.brokers th{border: 1px solid #0000;
border-collapse: collapse;
font-weight:300;
...
padding-left: 8px;}
.brokers td{border: 1px solid #000;
border-collapse: collapse;
font-size:14px;
text-align: left;
line-height:20px;
...
<script>
    ...
    $('form.wpcf7-form').submit(function(evt){
        ...
        $(this).append('<input type ="hidden" name = "formtype" value = "getintouchtenant">');
        $.ajax({
            type: 'POST',
...
<div>
  <div data-reactroot="" style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0); width: 100%; position: fixed; z-index: 1500; top: 0px; left: -10000px; box-sizing: border-box; height: 100%; transition: left 0ms cubic-bezier(0.23, 1, 0.32, 1) 450ms; padding: 0px; min-height: 434px; min-width: 310px;">
    <div></div>
    <div style="-webkit-tap-highlight-color: rgba(0, 0, 0, 0); width: 100%; top: 0px; left: -100%; opacity: 0; height: 100%; position: fixed; will-change: opacity; transform: translateZ(0px); transition: left 0ms cubic-bezier(0.23, 1, 0.32, 1) 400ms, opacity 400ms cubic-bezier(0.23, 1, 0.32, 1) 0ms; z-index: 1400; background-color: rgba(0, 0, 0, 0.541176);"><!-- react-empty: 4 --></div>
  </div>
</div>

                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="" style="display:block; float: none; text-align: left;">
                            <p class="gtm-black locations_main_title" style="color: rgb(187, 159, 125); font-size: 48px; text-transform: uppercase; margin-top:48px; margin-bottom: 0px;"><?php the_title(); ?></p>
                                <p class="gtm-medium" style="color: rgb(187, 159, 125); font-size: 14px; text-transform: uppercase; margin: 0px 0px 20px 0px;">
                                    <?php echo $post_slug = get_field('location', $post->ID);   //echo $post_slug = str_replace('-', ' ', get_post_field( 'post_name', get_post() )); ?>
                                 </p>
                                <div class="locations-text" style="font-family: 'Gotham A','Gotham B';font-style: 16px; padding:0px 0px 0px 0px; margin:0px;font-weight: 100;">
                                    <?php the_content(); ?>
                                    </div>
                        </div>
                        ...
                        <div class ="" style="vertical-align: top; float: none; font-weight: 100; margin-bottom: 40px; text-align: left;">
                        <div class ="location-lists" style="vertical-align: top; float: none; font-weight: 100;  margin-bottom: 15px; margin-top: 30px; text-align: left;">
                            <p class="gtm-thin gtm-thinn">Other Locations <i class="fa fa-map-marker" aria-hidden="true"></i></p>
                             <?php
                            $args = array('posts_per_page' => -1,'cat' => 12);
                            query_posts($args);
                            while (have_posts() ) : the_post(); 
                            if($parent_postid != $post->ID){
                            ?>
                            
                            <p class="gtm-black" style="margin: 0px; color: rgb(187, 159, 125); font-size: 40px; text-transform: uppercase;">
...
?>
                         ...
                         <div class="getintouch-cls getintouch-cls-location">
<p class="gtm-black" style="font-size: 20px; line-height: 27px; margin: 0 0 10px 0px;" data-radium="true">Inquire about Knotel  <?php echo $titleGet; ?>.</p>
<p class="gtm-book" style="font-size: 14px; margin: 0 0 10px 0px; line-height: 22px;" data-radium="true">Fill out this form, and we’ll get right back to you.</p> 
					...
					$selected = "";
					if(strtolower($post_slug) == strtolower($location) ){
					$selected = 'selected="selected"';
					}		
                                    ?>
                                    <option <?php echo $selected; ?> value="<?php echo $location; ?>"><?php echo $location; ?></option>
                                    <?php         
                                }
                        ?>
                        </select>
                        ...
                        <div style="position: relative;">
                            <input style=" color: #fff !important;" type="submit" class="btn btn-warning btn-lg locsubmitbtn" value="Submit">
                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/ajax-loader.gif" alt="loader" class="imageLoader" style="display:none;left: 50%;position: absolute;top: 42%;z-index: 9999999;">
                        </div>
        ...
        </form>  <p style="text-align: center; line-height: 24px; font-size: 14px; margin: 15px 0 0 0px;" data-radium="true"><span class="gtm-bold">OR CONTACT US DIRECTLY</span><span class="gtm-light" data-radium="true"><br>
646-979-0898<br>hellohello@knotel.com<br>
</span></p> 
                     </div> 
...
<div class="salesforceMsg"></div>
<!-- modal for book a tour -->


                 <?php get_template_part('footer'); ?>
            </div></div></div><style>@media screen and (max-width:480px){ .rmq-1f051394{height: 30vh !important;}}
...
<script> 
    ...
    $(document).on('click','div.ErrorShowCon span', function(){
        $(document).find('div.ErrorShowCon').fadeOut();
        $(document).find('.ErrorShow').text('');
    });
